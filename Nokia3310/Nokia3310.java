...
public class Nokia3310{
    ...
    switch(submenuChoicePhone){
        ...
        case 1:
        System.out.printf("SEARCH_%nsearch for contact here..%n");
        break;

        case 2:
        System.out.printf("ADD NAME_%n%nadd name here..%n");
        break;

        case 3:
        System.out.printf("EDIT_%n%nedit contact here..%n");
        break;
    ...
    switch(submenuChoiceMessages){
        ...
        case 1:
        System.out.printf("INBOX_%nfind your inboxes here..%n");
        break;

        case 2:
        System.out.printf("OUTBOX_%nfind your outboxes here..%n");
        break;
